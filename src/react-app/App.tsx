...
export const chakraFeelingPhrase: Record<string, string> = {
  ...
  "2": "энергия притяжения, я ощущаю невероятное влечение и страстное желание между нами",
  "3": "внутренняя сила, ты полон уважения и признания ко мне",
  "4": "забота, принятие и твоя искренность",
  "5": "сила, которая соединяет, в твоих словах я ощущаю общее направление наших душ",
...
export const userChakraOrigin: Record<string, string> = {
  ...
  "3": "внутренней силы, наполненной уважением и признанием",
...
export const partnerChannelChoice: Record<string, string> = {
  "Слова поддержки": "говоришь от сердца — словами, наполненными поддержки",
  "Время вместе": "остаёшься рядом — полностью, не отвлекаясь ни на что",
  "Подарки": "делишься простыми знаками любви",
...
export const userSoulImage: Record<string, string> = {
  ...
  "3": "пульс, один на двоих",
  "4": "ощущает дом — место, где я с тобой",
  "5": "раскрывается, как цветок",
  "6": "поёт и звучит изнутри",
  "7": "просто есть — в тишине с тобой"
};

export const chakraBuildVerb: Record<string, string> = {
  "1": "атмосфера, в которой спокойно",
  "2": "дыхание, в котором звучит наша близость",
  "3": "ощущение открытости между нами",
  "4": "мгновение, связывающее наши сердца",
  "5": "глубина, в которой рождаются чувства",
  "6": "время, где мы узнаем друг друга",
  "7": "тишина, в которой всё становится ясно без слов"
};

export const partnerSenseFinalChoice: Record<string, string> = {
  "Слова поддержки": "твои искренние слова поддержки",
  "Время вместе": "твоё полное внимание",
  "Подарки": "твои проявления заботы",
  "Помощь": "твоя забота",
...
export const mySenseFinalChoice: Record<string, string> = {
  ...
  "Время вместе": "я с тобой, без суеты и шума",
