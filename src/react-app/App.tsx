...
export function generateStructuredVow(data: string[]): {
  ...
  return {
    text: [
      ...
      ["💬 О нём", <>
        Я <i>{see}</i>, что в тебе живёт <i>{q2}</i>, и именно <i>{c2}</i>.<br/>
...
const langOptions = [
  { id: "Слова поддержки", label: "Слова, поддержка" },
  { id: "Время вместе", label: "Время вместе" },
  { id: "Подарки", label: "Подарки, внимание" },
  { id: "Помощь", label: "Поступки, забота" },
