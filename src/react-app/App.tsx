...
export const userChakraOrigin: Record<string, string> = {
  ...
  "3": "внутренней силы, в которой живёт стремление быть надёжным",
  "4": "тепла и спокойствия от тебя",
  "5": "твоих обращений, что соединяют нас в одно целое",
...
export const chakraBuildVerb: Record<string, string> = {
  ...
  "4": "контакт, в котором мы совпадаем",
  "5": "простая сцена доверия между нами",
...
export const partnerSenseFinalChoice: Record<string, string> = {
  "Слова поддержки": "твоя поддерживающая речь",
