    ...
    <div style={{ fontFamily: "'EB Garamond', serif", backgroundColor: "white", color: "#222", padding: "2rem", maxWidth: "640px", margin: "0 auto", textAlign: "center" as const }}>
      {step === -1 ? (
        ...
        <div style={{ marginTop: "1.5rem" }}>
          ...
          {result?.text.map((jsx, idx) => (
            <p key={idx} style={{ fontSize: "1.6rem", lineHeight: "1.6", fontWeight: 400 }}>{jsx}</p>
          ))}
          ...
          <div style={{ borderTop: "1px solid #ccc", paddingTop: "1.5rem", fontSize: "0.9rem", color: "#444" }}>
            <p style={{ lineHeight: "1.5" }}>
              ...
              И пусть слова будут любыми — главное, чтобы они были настоящими, вашими.<br /><br />
              Если ваши клятвы и их момент важен для вас — мы тоже так считаем.<br />
            ...
            <p>
              Ps. Ещё круче — почувствуйте на свадьбе то самое мгновение счастья — просто возьмите телефон и запишите свои слова любви.<br />
              Эти 5–10–50 секунд останутся с вами. Каждый — в свой момент, для себя.<br />
              А на следующий день — дома, в пижамах — поженитесь в блокчейне. Загрузите клятвы на Web3Wed. Это останется с вами — навсегда.<br />
              И если когда-нибудь станет сложно или просто захочется вернуться в свою вселенную — это можно будет сделать.
            </p>
          </div>
        </div>
      )}
