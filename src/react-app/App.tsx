        ...
        <div style={{ marginTop: "1.5rem" }}>
          ...
          <div style={{ borderTop: "1px solid #ccc", paddingTop: "1.5rem", fontSize: "0.9rem", color: "#444" }}>
            <p style={{ lineHeight: "1.5" }}>
              ...
              Курсивом выделены местаб которые ты ощущала - вспомни эти моменты.
              <br />
              ...
              <br />
              а слова — какими бы они ни были — говори от сердца, и они будут самыми правильными.
              <br />
              <br />
              Если ты считаешь что этот момент важен в твоей жизни, То мы тоже так считаем.
              Мы создали сервис <a href="https://web3wed.io" target="_blank" style={{ color: "#000", textDecoration: "underline" }}>web3wed.io</a>, 
              чтобы вы могли сохранить этот момент как видео ваших клятв - навсегда. 
              </p>
          </div>
        </div>
      )}
